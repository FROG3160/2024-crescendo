...
from phoenix6.configs.config_groups import Slot0Configs, Slot1Configs, MotorOutputConfigs
...
leadScrewVelocityGains = Slot1Configs().with_k_s(constants.kLeadScrewSlot1S).with_k_v(constants.kLeadScrewSlot1V)
